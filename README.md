...
- [改动](#改动)
  - [配置系统](#配置系统)
    - [条件模板特化(C++ 20之前)](#条件模板特化c-20之前)
    - [`concept + requires`(C++ 20) + `if constexpr`(C++ 17)](#concept--requiresc-20--if-constexprc-17)

# 前言
我是从头开始敲的，基本上遇到有复杂逻辑的地方都写了便于理解的注释。此外对于linux c++开发我自己也仍在学习中，如有错误还请多多包含。
...
### `concept + requires`(C++ 20) + `if constexpr`(C++ 17)
